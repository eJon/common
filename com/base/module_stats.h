...
//            (C) SINA Inc.
//
//           file: mscom/base/module_stats.h
//           desc: 
...
static inline int64_t rt_mstime() {
    struct timeval tv;
    int64_t ct;
...
class module_stat_trigger {
 public:
    ...
    virtual int s_warn(module_stat *self, int key, int64_t ts, int64_t now, int64_t avg, int64_t min, int64_t max) = 0;
    virtual int m_warn(module_stat *self, int key, int64_t ts, int64_t now, int64_t avg, int64_t min, int64_t max) = 0;
    virtual int h_warn(module_stat *self, int key, int64_t ts, int64_t now, int64_t avg, int64_t min, int64_t max) = 0;
    virtual int d_warn(module_stat *self, int key, int64_t ts, int64_t now, int64_t avg, int64_t min, int64_t max) = 0;
