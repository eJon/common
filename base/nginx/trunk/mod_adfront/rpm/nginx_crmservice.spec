...
##############################################################
Name:%(echo nginx_with_crmservice${SUFFIX})
# 
Version:%{_version}
...
cp $OLDPWD/../../mod_crmservice/conf/nginx.conf ./usr/local/nginx/conf/
cp $OLDPWD/../../mod_crmservice/conf/reserver.spio ./usr/local/nginx/conf/
...
%config(noreplace)	/usr/local/nginx/conf/reserver.spio
