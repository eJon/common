...
cp $OLDPWD/../build/release64/mem_db/mem_db.h .%{_prefix}/include/mem_db/
cp $OLDPWD/../build/release64/mem_db/mem_db_def.h .%{_prefix}/include/mem_db/
cp $OLDPWD/../misc/mem_db.conf .%{_prefix}/conf/mem_db/
cp $OLDPWD/../build/release64/lib/libmem_db.so .%{_prefix}/lib64/
