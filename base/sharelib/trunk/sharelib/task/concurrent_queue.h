#ifndef SHARELIB_TASK_CONCURRENT_QUEUE_H_
#define SHARELIB_TASK_CONCURRENT_QUEUE_H_
#include <iostream>
#include <queue>
...
{  
  private:  
    ...
    boost::condition_variable condition_variable_; // Message current queue.
    bool is_running_;
  ...
  private:
    DISALLOW_COPY_AND_ASSIGN(CurrentQueue);
...
#endif //end SHARELIB_TASK_CONCURRENT_QUEUE_H_
